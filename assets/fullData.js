let fullData = [
    ...
    geometry: {
      ...
      coordinates: [
        [
          ...
          [173.2505, -31.8576],
          [178.2272, -33.9081],
          [-160.2696 + 360, -23.1715],
          [-148.4071 + 360, -26.6824],
          [-137.4279 + 360, -27.9604],
        ],
      ],
    },
  },
  ...
  },
  {
    ...
    geometry: {
      ...
      coordinates: [
        [
          [-176.1435 + 360, 57.0326],
          [165.932, 61.751],
          [165.4603, 56.3824],
          [178.4577, 53.6948],
          [-176.1435 + 360, 57.0326],
          [-166.4927 + 360, 55.9598],
          [-159.0186 + 360, 54.9254],
          [-153.1148 + 360, 49.3133],
        ],
        [
          [178.4577, 53.6948],
          [176.5126, 47.7794],
